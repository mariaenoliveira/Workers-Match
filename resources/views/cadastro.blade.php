            ...
            <div class="card">
                <div class="card-content">
                    ...
                    <div class="dadospessoais">
                        ...
                        <input class=" nome input is-info" type="text" placeholder="Endereço" required>
                        </div>
                        <div class="cepnu">
                        <input class=" nome input is-info" type="text" placeholder="CEP" required>
                        <input class=" nome input is-info" type="text" placeholder="Número" required>
                        </div>
                        <div class="cepnu">
                        <input class=" nome input is-info" type="text" placeholder="Cidade" required>
                        <input class="nome input is-info" type="text" placeholder="Estado" required>
                        </div>
                        <div class="datase">
