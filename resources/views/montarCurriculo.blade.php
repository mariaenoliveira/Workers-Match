...
<body>
    ...
    <div hidden>
        <div class="entry entry-model">
            ...
            <button class="botao" onclick="apagar(this.parentNode)"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-lg" viewBox="0 0 16 16">
